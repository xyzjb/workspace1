...
if __name__ == "__main__":
    ...
    df2=df1[["sequence","x_basic_hour","x_basic_horizon","i_set","ec_ws","ec_wd","ec_tmp","ec_press","ec_rho","ec_dist","gfs_ws","gfs_wd","gfs_tmp","gfs_press","gfs_rho","gfs_dist","speed","power"]]
    #df2.head()   
